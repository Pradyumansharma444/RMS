        ...
        {/* Branding */}
          <div className="text-center mb-6">
            <motion.div 
              ...
              initial={{ rotate: 3 }}
              className="inline-flex items-center justify-center mb-4 cursor-default transition-all duration-500"
            >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      className="h-11 pl-11 bg-muted/30 border-none font-bold placeholder:font-medium focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:bg-background transition-all"
                      required
                    />
                  </div>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    placeholder="••••••••••••"
                    className="h-11 pl-11 pr-11 bg-muted/30 border-none font-bold placeholder:font-medium focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:bg-background transition-all"
                    required
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 p-1 rounded-md text-muted-foreground hover:text-primary hover:bg-primary/10 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20"
